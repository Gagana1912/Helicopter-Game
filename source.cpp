...
void display(void)
{
	...
	else if (wflag == 1)//Welcome Screen
	{
		...
		glColor3f(1.0, 1.0, 1.0);
		renderBitmapString(35, 96, 0, GLUT_BITMAP_HELVETICA_18, "RNS INSTITUTE OF TECHNOLOGY");
		renderBitmapString(41, 92, 0, GLUT_BITMAP_HELVETICA_12, "Bangalore, Karnataka-560098");
		glColor3f(1.0, 1.0, 0.0);
		renderBitmapString(20, 85, 0, GLUT_BITMAP_8_BY_13, "A mini project for Computer Graphics & Visualization Laboratery - 18CSL67");
		renderBitmapString(20, 80, 0, GLUT_BITMAP_8_BY_13, "BY : ADITI V JOSHI - 1RN19CS006   AND    GAGANA V - 1RN19CS051");
		renderBitmapString(39, 70, 0, GLUT_BITMAP_TIMES_ROMAN_24, "HELICOPTER GAME");
		glColor3f(1.0, 0.0, 0.0);
		renderBitmapString(40, 45, 0, GLUT_BITMAP_TIMES_ROMAN_24, "Welcome Player");
		renderBitmapString(33, 30, 0, GLUT_BITMAP_TIMES_ROMAN_24, "Click On The Screen To Start");
		renderBitmapString(17, 24, 0, GLUT_BITMAP_9_BY_15, "CLICK AND HOLD LEFT MOUSE BUTTON TO GO UP AND RELEASE TO GO DOWN");
	...
	else
	{
		...
		sprintf_s(slevel, "%d", level); //level
